aishell_data=/exdata/HOME/snie/code/asvspoof/speaker_asvspoof/dataset_min/speaker/speech

## make dataset
featdir=/exdata/HOME/snie/code/asvspoof/speaker_asvspoof/dataset_min/speaker/fbank
